...
class afc:
    def __init__(self, config):
        ...
        self.allow_cold_unload = config.getboolean('allow_cold_unload', False)      # Allow unloading filament after cutting without a temperature check
    ...
    def TOOL_UNLOAD(self, CUR_LANE):
        ...
        # Heat and prevent ooze if cold unload is not allowed
        if not self.allow_cold_unload:

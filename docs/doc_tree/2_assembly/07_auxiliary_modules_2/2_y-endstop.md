...
# Y Endstop
![]({{site.url}}/{{site.baseurl}}/assets/images/y_endstop.webp)
...
## Assembly Notes
 ...
 - **6:42** Continue to [Safety Switch]({{site.url}}/{{site.baseurl}}/doc_tree/2_assembly/07_auxiliary_modules_2/3_safety_switch.html)

## Interactive View
<div class="online_3d_viewer"
    model="https://media.githubusercontent.com/media/AutomatedLayers/VertigoMk1/main/docs/assets/3d/y_endstop.glb"

...
### 1. Attach the Foot Housing to the Frame
 ...
 - Use the Rear Feet Alignment Tool to align the **M5 Roll-In Nuts**
 - Drop the **M5 Hex Nut** into its hole and slide it into the slot in the Rear Foot Frame printed part
 - Attach the Rear Foot Frame printed part to the frame with an **M5x35 BHCS**

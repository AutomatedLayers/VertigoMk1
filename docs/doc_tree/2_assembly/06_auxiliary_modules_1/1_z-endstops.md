...
{: .note}
This is the first section where cables are installed, so it's a good time to check out the first section of the [Wiring Guide]({{site.url}}/{{site.baseurl}}/doc_tree/wiring.html)

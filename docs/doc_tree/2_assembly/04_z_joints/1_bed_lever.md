...
| Printed Parts                    | Qty |
|:---------------------------------|:-- -|
| <a href="https://github.com/AutomatedLayers/VertigoMk1/blob/main/hardware/STL/03%20Z%20Joints/Front%20Z%20Joints/Bed%20Lever/Bed%20Lever%20Frame%20Mount%20-%20Generate%20Supports.stl" target="_blank">Bed Lever Frame Mount</a> | 1   |
| <a href="https://github.com/AutomatedLayers/VertigoMk1/blob/main/hardware/STL/03%20Z%20Joints/Front%20Z%20Joints/Bed%20Lever/Bed%20Lever.stl" target="_blank">Bed Lever</a> | 1   |

## Animated Assembly

{: .important}
>WIP notes: 
>- The video shows the Front Z Joints being assembled before the bed lever. Feedback has suggested it is easier to attach the bed lever to the extrusion first to center it, then to move on to the Z Joints
...
### 1. Setup the Front Z Joint Bar
 ...
 - Use the Bed Lever Frame Mount  to align the Roll-In Nuts. The whole assembly will be centered later on the extrusion.

### 2. Assemble the Bed Lever

 - Drop a dab of red Loctite on the Tooling Ball thread.
 - Place the M5x10x1 Washer on the Bed Lever and screw the Tooling Ball through the washer and lever into an M5 Hex Nut.
 - Use a cloth (optional) and pliers on the Tooling Ball shank to tighten it to the Bed Lever.
 - Push 2 M3x60 Dowels into the Bed Lever. These add to the rigidity of the lever.
 - Attach the Strike Plate to the lever using 2 M3x10 FHCS and 2 M3 Hex Nuts.
 - On each outer side of the Bed Lever Frame Mount, thread in an M2x8 SHCS until the end is flush with the inner face of the part.
 ...
 - Position the Bed Lever  in the Frame Mount and push an M5x60 D-Shaft through both parts. The fit should be very snug in the lever.

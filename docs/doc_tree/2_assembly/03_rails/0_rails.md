...
{: .important}
Take care not to overtighten the linear rail screws. Snug is good.

<!-- 
 - Remove alignment tools.

### 2. Attach the Rear Z-Rails to the Frame
 - Repeat the process for the rear Z-rails.
...
### 3. Attach the Y-Rails to the Frame
 ...
 - **1:40** Rubber stoppers that come with the rails may be used here to keep the carriages from accidentally sliding off.
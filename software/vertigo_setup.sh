...
echo -e "config_variables.cfg"
curl -L -o "config_variables.cfg" "https://raw.githubusercontent.com/AutomatedLayers/VertigoMk1/refs/heads/main/software/Printer%20Config/config_variables.cfg"
echo -e "sonar.conf"
